...
locals {
  ...
  tunnel_ingress = [
    ...
    { hostname = "staging.miora.now", service = local.ingress_nginx_origin },

    # IDDH production runs here (see the members repo, docs/host-topology.md).
    # One Phoenix deployment serves all of these:
